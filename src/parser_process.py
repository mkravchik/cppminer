...
class ParserProcess(multiprocessing.Process):
    def __init__(self, task_queue, max_contexts_num, max_path_len, max_subtokens_num, max_ast_depth, input_path, output_path, window=0, step=0):
        multiprocessing.Process.__init__(self)
        self.task_queue = task_queue
        self.parser = AstParser(max_contexts_num, max_path_len, max_subtokens_num, max_ast_depth, output_path, input_path, window, step)
        try:
